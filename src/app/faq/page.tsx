    ...
    <div>
      ...
      <main className="mx-auto max-w-4xl px-4 py-16 space-y-16">
        <section className="space-y-6">
          ...
          <h1 className="font-display text-4xl text-leather">FAQ</h1>
          ...
          <p className="text-lg text-taupe leading-relaxed">
            La FAQ est modifiable depuis l&apos;espace d&apos;administration.
          </p>
        </section>

        <section className="rounded-3xl border border-gold/20 bg-white/80 p-8 backdrop-blur-sm shadow-sm">
          <div className="whitespace-pre-line text-sm text-taupe leading-relaxed">{faq}</div>
        </section>
      </main>
      <Footer />
    </div>
