...
export default async function PrivacyPolicyPage() {
  const { politique_confidentialite } = await getLegalTexts()
      ...
      <main className="mx-auto max-w-4xl px-4 py-16 space-y-16">
        <section className="space-y-6">
          ...
          <p className="text-lg text-taupe leading-relaxed">
            La politique de confidentialité est modifiable depuis l&apos;espace d&apos;administration.
          </p>
        </section>

        <section className="rounded-3xl border border-gold/20 bg-white/80 p-8 backdrop-blur-sm shadow-sm">
          <div className="whitespace-pre-line text-sm text-taupe leading-relaxed">
