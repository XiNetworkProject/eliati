      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-taupe mb-4">Contacteliati@gmail.com</p>
            
            <h3 className="font-display text-lg mb-3 mt-6">Suivez-nous</h3>
            <div className="flex gap-4">
              <a 
                href="https://www.facebook.com/profile.php?id=61583076211318"
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 bg-white hover:bg-leather rounded-xl border border-gold/30 hover:border-leather transition-all duration-300 shadow-sm hover:shadow-md"
                aria-label="Facebook"
              >
